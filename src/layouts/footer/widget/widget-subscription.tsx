  ...
  return (
    ...
    >
      ...
      <Input
        ...
        variant="solid"
        className="w-full"
        inputClassName="ps-10 md:ps-10 pe-10 md:pe-10 2xl:px-11 h-12 rounded-md bg-transparent border-black/10 focus:outline-none focus:shadow-outline text-gray-400"
        {...register('email', {

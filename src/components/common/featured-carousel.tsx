    ...
    return (
        ...
        >
            <Carousel
                ...
                prevButtonClassName="-start-6  3xl:top-auto 3xl:-translate-y-2 4xl:-translate-y-10"
                nextButtonClassName={`-end-6  3xl:top-auto transform 2xl:translate-x-0 3xl:-translate-y-2 `}
                className={``}
            >
                {data?.map((item) => (
